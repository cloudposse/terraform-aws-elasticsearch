...
| <a name="input_elasticsearch_version"></a> [elasticsearch\_version](#input\_elasticsearch\_version) | Version of Elasticsearch to deploy (\_e.g.\_ `7.4`, `7.1`, `6.8`, `6.7`, `6.5`, `6.4`, `6.3`, `6.2`, `6.0`, `5.6`, `5.5`, `5.3`, `5.1`, `2.3`, `1.5` | `string` | `"7.10"` | no |
...
| <a name="input_iam_irsa_service_accounts"></a> [iam\_irsa\_service\_accounts](#input\_iam\_irsa\_service\_accounts) | Kubernetes ServiceAccounts to allow to access the Elastic Domain via IRSA | `list(string)` | `[]` | no |
